...
export default function Page() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`/api/transactions?transaction_type=pengeluaran&limit=${dataLimit}`, {
    ...
    return <Navbar title="Pengeluaran">
        ...
        <div className="w-15 h-15 rounded-full flex justify-center items-center bg-black text-white absolute right-4 bottom-0" onClick={() => route.push("/pengeluaran/tambah")}><Plus /></div>
    </Navbar>
}
