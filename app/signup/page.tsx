...
export default function RegisterPage(): React.ReactElement {
  return (
    <div className="min-h-screen bg-gray-50 flex items-start justify-center px-6 py-10">
      <div className="w-full max-w-md space-y-6">

        <div>
          <h1 className="text-2xl font-bold">Daftar</h1>
          <p className="text-gray-600 text-sm">Daftar untuk melanjutkan.</p>
        </div>

        <InputWithLabel label="Nama" id="nama" />
