        ...
        <DialogContent>
            ...
            <div className="flex flex-col gap-4">
                ...
                {transaction.receiptImage && <div className="w-full h-30 relative">
                    <Image src={`${process.env.NEXT_PUBLIC_CDN_DOMAIN}/${transaction.receiptImage}`} alt="Preview Gambar" width={200} height={200} unoptimized className="w-full h-full rounded-lg object-cover" />
